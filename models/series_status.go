...
func init() {
	orm.RegisterModel(new(SeriesStatus))
}

// AddSeriesStatus insert a new SeriesStatus into database and returns
...
// GetSeriesStatusById retrieves SeriesStatus by Id. Returns error if
// Id doesn't exist
func GetSeriesStatusById(id int) (v *SeriesStatus, err error) {
	o := orm.NewOrm()
	v = &SeriesStatus{Id: id}
...
// DeleteSeriesStatus deletes SeriesStatus by Id and returns error if
...
func DeleteSeriesStatus(id int) (err error) {
	...
	if err = o.Read(&v); err == nil {
		var num int64
		if num, err = o.Delete(&SeriesStatus{Id: id}); err == nil {
